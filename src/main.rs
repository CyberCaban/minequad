...
use systems::{ blocks::{Block, BlockType, RenderSides}, demo_features::DemoFeatures};
...
async fn main() {
        ...
        for x in 0..3 {
            ...
            for z in 0..CHUNK_SIZE_16 {
                ...
                let block_tex = &textures[match block_type {
                    ...
                    let mut block = Block::new(block_type, block_pos, block_tex.clone());
    ...
    let mut demo = DemoFeatures::new(textures[0].clone());
    let mut player = Player::new();
    let mut projection = 0;
    let LIGHTBLUE = Color { r: 135.0 / 255.0, g: 206.0 / 255.0, b: 250.0 / 255.0, a: 1.0 };
